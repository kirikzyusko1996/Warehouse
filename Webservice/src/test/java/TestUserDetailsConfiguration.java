...
public class TestUserDetailsConfiguration {
    ...
    public UserDetails userDetails() {
        ...
        roleSupervisor.setName(UserRoleEnum.ROLE_SUPERVISOR.toString());
        Role roleDispatcher = new Role();
        roleDispatcher.setName(UserRoleEnum.ROLE_DISPATCHER.toString());
        Role roleAdmin = new Role();
        roleAdmin.setName(UserRoleEnum.ROLE_ADMIN.toString());
        Role roleController = new Role();
        roleController.setName(UserRoleEnum.ROLE_CONTROLLER.toString());
        Role roleManager = new Role();
        roleManager.setName(UserRoleEnum.ROLE_MANAGER.toString());
        Role roleOwner = new Role();
        roleOwner.setName(UserRoleEnum.ROLE_OWNER.toString());
